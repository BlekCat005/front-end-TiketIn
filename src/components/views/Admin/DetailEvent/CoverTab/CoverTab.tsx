...
const CoverTab = (props: PropTypes) => {
  ...
  const handleUpdateCover = (data: { banner: string | FileList }) => {
    const updatePayload: Partial<IEventForm> = {
      banner: data.banner,
    };

    onUpdate(updatePayload as IEventForm); // 👈 cast ke IEventForm karena fungsi aslinya expect itu
  };
    ...
    <Card className="w-full p-4 lg:w-1/2">
      ...
      <CardBody>
        <form
          ...
          onSubmit={handleSubmitUpdateCover(handleUpdateCover)}
        >
